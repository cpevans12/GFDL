#this does the same thing, getting prcptot slopes, but it just plots the maps on blank maps for the webpage
...
sources = ['livneh', 'nclimgrid', 'prism']
...
for i in range(1):
    ...
    for j in range(3):
        ax = fig.add_subplot(1,3,(j+1),projection=ccrs.Mercator())
        ax.set_extent(extents[str(region_names[i])], crs=ccrs.PlateCarree())
        c = plt.contourf(lon,lat,globals()[sources[j]+'_'+str(regions_names_alt[i])],transform=ccrs.PlateCarree(),cmap=get_cmap("BrBG"),norm=norm,extend='both')
...
for i in range(7):
    ...
    ax.set_extent(extents[str(region_names[i])], crs=ccrs.PlateCarree())
    c = plt.contourf(lon,lat,globals()['livneh_'+str(regions_names_alt[i])],transform=ccrs.PlateCarree(),cmap=get_cmap("BrBG"),norm=norm,extend='both')
    plt.savefig(image_dir+'livneh_prcptot_slope_'+str(regions_names_alt[i])+'_blank.png',dpi=300,bbox_inches='tight', pad_inches=0)
    plt.show()
    plt.close()
...
for i in range(7):
    ...
    ax = fig.add_subplot(1,1,1,projection=ccrs.Mercator())
    ax.set_extent(extents[str(region_names[i])], crs=ccrs.PlateCarree())
    c = plt.contourf(lon,lat,globals()['nclimgrid_'+str(regions_names_alt[i])],transform=ccrs.PlateCarree(),cmap=get_cmap("BrBG"),norm=norm,extend='both')
    plt.savefig(image_dir+'nclimgrid_prcptot_slope_'+str(regions_names_alt[i])+'_blank.png',dpi=300,bbox_inches='tight', pad_inches=0)
    plt.show()
    plt.close()
...
for i in range(7):
    ...
    ax = fig.add_subplot(1,1,1,projection=ccrs.Mercator())
    ax.set_extent(extents[str(region_names[i])], crs=ccrs.PlateCarree())
    c = plt.contourf(lon,lat,globals()['prism_'+str(regions_names_alt[i])],transform=ccrs.PlateCarree(),cmap=get_cmap("BrBG"),norm=norm,extend='both')
    plt.savefig(image_dir+'prism_prcptot_slope_'+str(regions_names_alt[i])+'_blank.png',dpi=300,bbox_inches='tight', pad_inches=0)
    plt.show()
    plt.close()
...
for i in range(7):
    for j in  range(16):
        ...
        ax = fig.add_subplot(1,1,1,projection=ccrs.Mercator())
        ax.set_extent(extents[str(region_names[i])], crs=ccrs.PlateCarree())
        c = plt.contourf(lon,lat,globals()['loca2_'+str(models[j])+str(regions_names_alt[i])],transform=ccrs.PlateCarree(),cmap=get_cmap("BrBG"),norm=norm,extend='both')
        plt.savefig(image_dir+'loca2_prcptot_slope_'+str(models[j])+'_'+str(regions_names_alt[i])+'_blank.png',dpi=300,bbox_inches='tight', pad_inches=0)
        plt.show()
        plt.close()
...
for i in range(7):
    ...
    ax = fig.add_subplot(1,1,1,projection=ccrs.Mercator())
    ax.set_extent(extents[str(region_names[i])], crs=ccrs.PlateCarree())
    c = plt.contourf(lon,lat,globals()["loca2_"+str(regions_names_alt[i])+"_ensemble_mean"],transform=ccrs.PlateCarree(),cmap=get_cmap("BrBG"),norm=norm,extend='both')
    plt.savefig(image_dir+'loca2_ensemble_mean_prcptot_slope_'+str(regions_names_alt[i])+'_blank.png',dpi=300,bbox_inches='tight', pad_inches=0)
    plt.show()
    plt.close()
...
for i in range(7):
    for j in  range(16):
        ...
        ax = fig.add_subplot(1,1,1,projection=ccrs.Mercator())
        ax.set_extent(extents[str(region_names[i])], crs=ccrs.PlateCarree())
        c = plt.contourf(lon,lat,globals()['star_'+str(models[j])+str(regions_names_alt[i])],transform=ccrs.PlateCarree(),cmap=get_cmap("BrBG"),norm=norm,extend='both')
        plt.savefig(image_dir+'star_prcptot_slope_'+str(models[j])+'_'+str(regions_names_alt[i])+'_blank.png',dpi=300,bbox_inches='tight', pad_inches=0)
        plt.show()
        plt.close()
...
for i in range(7):
    ...
    ax = fig.add_subplot(1,1,1,projection=ccrs.Mercator())
    ax.set_extent(extents[str(region_names[i])], crs=ccrs.PlateCarree())
    c = plt.contourf(lon,lat,globals()["star_"+str(regions_names_alt[i])+"_ensemble_mean"],transform=ccrs.PlateCarree(),cmap=get_cmap("BrBG"),norm=norm,extend='both')
    plt.savefig(image_dir+'star_ensemble_mean_prcptot_slope_'+str(regions_names_alt[i])+'_blank.png',dpi=300,bbox_inches='tight', pad_inches=0)
    plt.show()
    plt.close()
